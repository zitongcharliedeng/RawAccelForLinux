...
static void
term_ostream__flush (term_ostream_t stream, ostream_flush_scope_t scope)
{
  output_buffer (stream, stream->default_attr);
  if (scope == FLUSH_ALL)
    {
...
static const char *
term_ostream__get_hyperlink_ref (term_ostream_t stream)
{
...
static const char *
term_ostream__get_hyperlink_id (term_ostream_t stream)
{
  hyperlink_t *hyperlink = stream->curr_attr.hyperlink;
...
static void
term_ostream__set_hyperlink (term_ostream_t stream,
...
static void
term_ostream__flush_to_current_style (term_ostream_t stream)
{
...
const struct term_ostream_implementation term_ostream_vtable =
{
  ...
  term_ostream__get_hyperlink_ref,
